...
from accounts.models import User, Group, UserGroup, GroupPermission
...
class EmployeeSerializer(serializers.ModelSerializer):
    ...
    def get_groups(self, obj):
        groupsDB = UserGroup.objects.filter(user_id=obj.user.id).all()
        groupsDATA = []
...
class TaskSerializer(serializers.ModelSerializer):
    ...
    def update(self, instance, validated_data):
        ...
        instance.status_id = validated_data.get('status', instance.status_id)
